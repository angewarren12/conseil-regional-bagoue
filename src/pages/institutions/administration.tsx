...
const AdministrationPage = () => {
  return (
    <>
      <Head>
        <title>L'Administration - Conseil Régional de la Bagoué</title>
        <meta name="description" content="Découvrez l'Administration du Conseil Régional de la Bagoué, son organisation et ses services." />
      </Head>
        ...
        <div className="relative bg-gradient-to-r from-blue-900 to-blue-800 mb-12">
          ...
          <div className="container mx-auto px-4 py-16 relative">
            <div className="flex flex-col items-center text-center">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">L'Administration</h1>
              <p className="text-xl text-white/90 max-w-2xl">
                Les services administratifs du Conseil Régional de la Bagoué
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="max-w-3xl mx-auto text-center py-12">
            ...
            <p className="text-gray-600">
              Le contenu détaillé de l'Administration sera bientôt disponible.
            </p>
          </div>
        </div>
      </main>
